...
- Release diagnostics now persist to `%LOCALAPPDATA%\com.meetily.ai\logs\PulseTalk.log` instead of disappearing with the Windows GUI process. The active file is limited to 1 MB and four rotated archives are retained. A packaged-release launch created an 8.8 KB log containing `Application setup complete` and `dictation_shortcut_registered shortcut=Ctrl+Shift+Space`.
...
- Size: `43,578,391 bytes`
- SHA-256: `901F29162B7D65DF5DDBDCA729EA4FFD91D3AF6B72096D629EB34F65C7A1ACAC`
