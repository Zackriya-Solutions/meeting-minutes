...
console.log(`GitHub Repository: Qblaauw/PulseTalq`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/Qblaauw/PulseTalq/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/Qblaauw/PulseTalq/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/Qblaauw/PulseTalq/releases/latest/download/latest.json`);
