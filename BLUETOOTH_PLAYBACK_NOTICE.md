...
When **reviewing recordings** in PulseTalq, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **PulseTalq records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing PulseTalq recordings** - Use wired/speakers instead
...
### This is Not a PulseTalq Bug

The issue is in **macOS's Bluetooth audio stack**, not in PulseTalq's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a PulseTalq bug. We've correctly recorded at 48kHz.
...
**A**: Yes! PulseTalq now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: PulseTalq v0.0.5+ on macOS
