# GPU-accelerated development script for Conversationaly (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Conversationaly" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Conversationaly in development mode..." -ForegroundColor Blue
Write-Host ""
