# GPU-accelerated development script for PulseTalq (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for PulseTalq" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting PulseTalq in development mode..." -ForegroundColor Blue
Write-Host ""
