              ...
              {TABS.map((tab, index) => {
                ...
                return (
                  <TabsTrigger
                    ...
                    className="flex items-center gap-2 px-6 py-4 bg-transparent rounded-none border-0 data-[state=active]:bg-transparent data-[state=active]:text-info data-[state=active]:shadow-none text-muted-foreground hover:text-foreground relative z-10"
                  >
