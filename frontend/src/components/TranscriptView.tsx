...
export const TranscriptView: React.FC<TranscriptViewProps> = ({ transcripts, isRecording = false, isPaused = false, isProcessing = false, isStopping = false, enableStreaming = false }) => {
  ...
  return (
    <div className="px-4 py-2">
      ...
      <AnimatePresence>
        {isRecording && (
          <div className="sticky top-4 z-10 bg-elevated pb-2">
        ...
        return (
          ...
          >
            <div className="flex items-start gap-2">
              <Tooltip>
                <TooltipTrigger>
                  <span className="text-xs text-ink-faint mt-1 flex-shrink-0 min-w-[50px]">
          ...
          {isRecording ? (
            <>
              <div className="flex items-center justify-center mb-3">
                <div className={`w-3 h-3 rounded-full ${isPaused ? 'bg-warn' : 'bg-brand animate-pulse'}`}></div>
              </div>
            ...
            <>
              <p className="text-lg font-semibold">Welcome to conversationaly!</p>
