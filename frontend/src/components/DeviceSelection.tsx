...
import { RefreshCw, Mic, Speaker } from '@/components/deslop-icons';
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h4 className="text-sm font-medium text-foreground">{t('Audio Devices')}</h4>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="mic-selection" className="text-sm font-medium text-muted-foreground">
              {t('Microphone')}
            </Label>
          </div>
          <Select
          ...
          {inputDevices.length === 0 && (
            <p className="text-xs text-muted-foreground">{t('No microphone devices found')}</p>
          )}

          {/* Audio Level Meters for Input Devices */}
          {showLevels && inputDevices.length > 0 && (
            <div className="space-y-2 pt-2 border-t border-border">
              <p className="text-xs text-muted-foreground font-medium">{t('Microphone Levels:')}</p>
              {inputDevices.map((device) => {
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="system-selection" className="text-sm font-medium text-muted-foreground">
              {t('System Audio')}
            </Label>
          </div>
          ...
          {outputDevices.length === 0 && (
            <p className="text-xs text-muted-foreground">{t('No system audio devices found')}</p>
          )}
