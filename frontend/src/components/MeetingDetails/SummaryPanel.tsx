            ...
            <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg p-4 max-h-1/3 overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h4 className="font-medium mb-1">{t("summarySettings.keyPoints")}</h4>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">{t("summarySettings.actionItems")}</h4>
                  <ul className="list-disc pl-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">{t("summarySettings.decisions")}</h4>
                  <ul className="list-disc pl-4">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm mt-4">
                  <h4 className="font-medium mb-1">{t("summarySettings.mainTopics")}</h4>
                  <ul className="list-disc pl-4">
              ...
              {summaryResponse.raw_summary ? (
                <div className="mt-4">
                  <h4 className="font-medium mb-1">{t("summarySettings.fullSummary")}</h4>
