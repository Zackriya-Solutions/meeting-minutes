      ...
      <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-between">
              <div className="flex items-center justify-between gap-4">
                ...
                <PulseTalkMark className="h-11 w-11 text-[#536ee8] transition-transform group-hover:scale-105" />
              </div>
              <div>
                ...
                <p className="mt-1 max-w-lg text-sm text-[#adbac0]">
                  {dictation.phase === 'listening'
                    ...
                    : dictation.message ?? 'Hold the shortcut while speaking. PulseTalk transcribes locally, then pastes where you were typing.'}
                </p>
        ...
        <div className="mt-4 grid gap-4 xl:grid-cols-[minmax(0,1.4fr)_minmax(280px,.8fr)]">
          ...
          <section className="rounded-[22px] border border-[#dce2e6] bg-white p-5">
            <div className="flex items-start justify-between"><div><h2 className="font-semibold">Recent meetings</h2><p className="text-xs text-[#7b8791]">Stored on this device</p></div><CalendarDays className="h-5 w-5 text-[#536ee8]" /></div>
