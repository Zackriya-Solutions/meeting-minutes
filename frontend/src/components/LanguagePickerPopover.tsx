...
export function LanguagePickerPopover({
  ...
  return (
    <div
      ref={containerRef}
      className="w-72 rounded-lg bg-elevated border border-line shadow-lg overflow-hidden"
      role="dialog"
    ...
    >
      <div className="flex items-center gap-2 px-3 py-2.5 border-b border-line">
        ...
        <input
          ...
          className="flex-1 text-sm text-ink bg-transparent border-none outline-none placeholder:text-ink-muted"
        />
      </div>
      ...
      <div className="max-h-80 overflow-y-auto py-1">
        {showRecents && (
          <>
            <div className="px-3 pt-1 pb-1 text-[10px] font-semibold uppercase tracking-wider text-ink-faint">
              Recently Used
            </div>
