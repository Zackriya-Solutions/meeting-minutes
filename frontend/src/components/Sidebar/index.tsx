...
const Sidebar: React.FC = () => {
  ...
  const handleDelete = async (itemId: string) => {
    ...
    try {
      ...
      // Show success toast
      toast.success(t('sidebar.deleteMeetingSuccess'), {
        description: t('sidebar.deleteMeetingSuccessDescription')
      });
      ...
      toast.error(t('sidebar.deleteMeetingError'), {
  ...
  const handleEditConfirm = async () => {
    ...
    try {
      ...
      toast.error(t('sidebar.meetingTitleUpdateError'), {
        description: error instanceof Error ? error.message : String(error)
      });
    }
  };
    ...
    <div className="fixed top-0 left-0 h-screen z-40">
      ...
      <Dialog open={editModalState.isOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-[425px]">
          <VisuallyHidden>
            <DialogTitle>{t('sidebar.editMeetingTitleDialog')}</DialogTitle>
          </VisuallyHidden>
          <div className="py-4">
            <h3 className="text-lg font-semibold mb-4">{t('sidebar.editMeetingTitleDialog')}</h3>
