#!/bin/bash
# GPU-accelerated development script for Conversationaly
...
echo -e "${BLUE}🚀 Conversationaly GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting Conversationaly in development mode...${NC}"
echo ""
