#!/bin/bash
# GPU-accelerated development script for PulseTalq
...
echo -e "${BLUE}🚀 PulseTalq GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting PulseTalq in development mode...${NC}"
echo ""
