...
by older Conversationaly development flows.

## Current Supported Integration

The supported Conversationaly app no longer requires a manually started whisper-server
