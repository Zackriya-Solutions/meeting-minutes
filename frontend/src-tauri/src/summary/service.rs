...
impl SummaryService {
    ...
    /// * `summary_chunk_system_prompt` - System prompt used to summarize each transcript chunk
    /// * `summary_chunk_prompt` - User prompt used to summarize each transcript chunk
    /// * `summary_combine_system_prompt` - System prompt used to combine chunk summaries
    ...
    pub async fn process_transcript_background<R: tauri::Runtime>(
        ...
        summary_chunk_system_prompt: String,
        summary_chunk_prompt: String,
        summary_combine_system_prompt: String,
        ...
        let result = generate_meeting_summary(
            ...
            Some(&summary_chunk_system_prompt),
            Some(&summary_chunk_prompt),
            Some(&summary_combine_system_prompt),
