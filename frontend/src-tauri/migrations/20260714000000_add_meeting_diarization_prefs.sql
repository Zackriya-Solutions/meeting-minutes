...
-- (SaluteSpeech): forwarded as speaker_separation_options.count (the REST field;
-- the gRPC proto name count_of_speaker is rejected by the gateway with HTTP 400).
