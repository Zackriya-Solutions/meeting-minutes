@echo off
REM PulseTalq Build Script for Windows
...
echo 🚀 Building PulseTalq application...
...
echo.
echo ========================================
echo    PulseTalq Build Script - Help
echo ========================================
echo.
echo USAGE:
...
echo.
echo DESCRIPTION:
echo   This script builds the PulseTalq Tauri application for Windows.
