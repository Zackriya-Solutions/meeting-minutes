@echo off
REM Conversationaly Build Script for Windows
...
echo 🚀 Building Conversationaly application...
...
echo.
echo ========================================
echo    Conversationaly Build Script - Help
echo ========================================
echo.
echo USAGE:
...
echo.
echo DESCRIPTION:
echo   This script builds the Conversationaly Tauri application for Windows.
